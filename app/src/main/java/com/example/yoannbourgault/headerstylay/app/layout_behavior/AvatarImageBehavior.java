package com.example.yoannbourgault.headerstylay.app.layout_behavior;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<ImageView> {
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mCustomFinalYPosition = a.getDimension(R.styleable.AvatarImageBehavior_finalYPosition,
                    0);
            mCustomStartXPosition = a.getDimension(R.styleable.AvatarImageBehavior_startXPosition,
                    0);
